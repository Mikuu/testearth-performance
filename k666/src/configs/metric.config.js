...
export default {
    ...
    queryBookRequest: {
        errors: new Counter("cm_query_book_errors"),
        requests: new Counter("cm_query_book_reqs"),
        requestDuration: new Trend("cm_query_book_req_duration", true),

        requestSending: new Trend("cm_query_book_req_sending", true),
        requestWaiting: new Trend("cm_query_book_req_waiting", true),
        requestReceiving: new Trend("cm_query_book_req_receiving", true),
    },
